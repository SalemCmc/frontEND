...
class MessagesPanel extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showMsgBlock: false,  logedUser: null, hoverItem: -1, searchString:""
    };
  ...
  async changeRole() {
    ...
    if(this.props.messages.employees.length<1 || this.props.messages.clients.length<1)
    {
        ...
        <div className="leftnavipanel">
          ...
          <div className="messagesearchelem">
            <input className="form-control form-control-sm" ref={(ref) => this.SearchString = ref} placeholder="Search..."
             type="text"  onChange={() => { this.getSenders() }}     />
          </div>
