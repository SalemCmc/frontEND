...
import { getTimelineItemDetails, getPetDetails } from "../WebApis/requestsGraphQL.js";
...
class PetDetail extends Component {
    constructor(props) {
        super(props);
        this.state = { petDetail: {}, itemDetails: null, showRightPanel: false, showPanelAt: ["", "hidde"] };
            ...
            <div className="" >
                ...
                <div className="tabsdiv">
                    ...
                    <div className={this.state.showPanelAt[1]}>
                        <AppointmentTimeline id={this.props.petID} type="SERVICES" onClick={this.selectItem} />
